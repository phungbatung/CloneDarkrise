...
public class RangedEnemyJumpState : CharacterState
{
    private RangedEnemy enemy;
    public RangedEnemyJumpState(Character _character, StateMachine _stateMachine, string _animBoolName) : base(_character, _stateMachine, _animBoolName)
    {
